        ...
        <CardHeader className="relative z-10 p-0 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-surface-container-low border border-outline-variant/50 text-[#444749] dark:text-[#c5c7c8] shadow-sm">
              ...
              <div className="space-y-3 mt-4">
                <div className="flex flex-wrap items-center gap-4">
                  <div className="flex items-center gap-2">
                    <Label className="text-sm font-sans font-semibold text-on-surface-variant">View:</Label>
                    <Select
                      value={dateFilter}
                    ...
                    >
                      <SelectTrigger className="w-[120px] h-9 bg-[#ffffff] dark:bg-[#14171a] border border-outline-variant text-on-surface rounded-lg shadow-sm font-sans font-medium hover:border-[#496177]/50 transition-colors">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  {dateFilter === 'day' && (
                    ...
                    >
                      <Label className="text-sm font-sans font-semibold text-on-surface-variant">Date:</Label>
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                            className={cn(
                              "w-[200px] bg-[#ffffff] dark:bg-[#14171a] border border-outline-variant text-on-surface rounded-lg shadow-sm font-sans hover:border-[#496177]/50 hover:bg-surface-container transition-colors",
                              "h-9 justify-start text-left font-medium",
                              !selectedDate && "text-muted-foreground"
                            )}
                          >
                            <span className="material-symbols-outlined text-sm mr-2 flex-shrink-0">calendar_month</span>
                  ...
                  {dateFilter === 'week' && (
                    <motion.div
                      ...
                      className="flex items-center gap-2"
                    >
                      <Label className="text-sm font-sans font-semibold text-on-surface-variant">Week:</Label>
                      <Select
                      ...
                      >
                        <SelectTrigger className="w-[200px] h-9 bg-[#ffffff] dark:bg-[#14171a] border border-outline-variant text-on-surface rounded-lg shadow-sm font-sans font-medium hover:border-[#496177]/50 transition-colors">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          {[1, 2, 3, 4].map(week => {
                ...
                {dateFilter !== 'month' && (
                  <motion.div
                    ...
                    className="text-sm font-sans font-medium text-on-surface-variant"
                  >
              ...
              <CardContent className="relative z-10" id="expenses-content">
                {monthLoading && !optimisticUpdateActive ? (
                  <div className="flex items-center justify-center py-8">
                    <Loader2 className="h-6 w-6 animate-spin text-[#5e604d]" />
                    <span className="ml-2 text-sm text-[#8b8579] dark:text-[#a39e93]">Loading expenses...</span>
                  </div>
                ) : filteredExpenses.length === 0 ? (
                  <p className="text-center text-[#8b8579] dark:text-[#a39e93] py-8">
                    {dateFilter === 'day'
                        ...
                        >
                          {isOptimistic && (
                            <div className="absolute top-2 right-2">
                              <span className="text-xs bg-[#5e604d] text-white px-2 py-1 rounded-full flex items-center gap-1">
                            ...
                            {expense.receipt && (
                              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                                <Button
                                  ...
                                  className="text-[#496177] hover:text-[#171c1f] hover:bg-[#eaeef2] dark:text-[#b0c9e3] dark:hover:text-[#f6fafe] dark:hover:bg-[#24282c] rounded-lg h-8 w-8 p-0"
                            ...
                            {!isOptimistic && (
                              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                                <Button
                                  ...
                                  className="text-[#ba1a1a] hover:text-[#93000a] hover:bg-[#ffdad6] dark:hover:bg-[#93000a]/20 disabled:opacity-50 rounded-lg h-8 w-8 p-0"
                                >
  ...
  const renderVisualizationContent = () => (
    ...
    >
      <div className="space-y-6">
        ...
        <Card className="relative bg-white dark:bg-[#1c2024] border border-[#c4c7c8]/60 dark:border-[#353a40] rounded-xl overflow-hidden shadow-xs p-2 sm:p-4">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#cce5ff]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />


          <CardContent className="space-y-6 relative z-10 p-4 sm:p-6" id="analytics-content">
            {monthLoading ? (
              <div className="flex items-center justify-center py-12">
                <Loader2 className="h-6 w-6 animate-spin text-[#212529]" />
                <span className="ml-2 text-sm text-[#5b5f63]">Loading analytics...</span>
              </div>
            ) : (
              <>
        ...
        <Card className="relative bg-white dark:bg-[#1c2024] border border-[#c4c7c8]/60 dark:border-[#353a40] rounded-xl overflow-hidden shadow-xs p-2 sm:p-4">
          ...
          <CardHeader className="relative z-10 p-4 sm:p-6 pb-2">
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#212529] text-white dark:bg-[#f6fafe] dark:text-[#14171a] shadow-xs">
                <Zap className="h-5 w-5" />
              </div>
              <div>
                <CardTitle className="text-xl font-bold font-serif-heading tracking-tight text-on-surface">Utility Analytics</CardTitle>
                <CardDescription className="text-xs font-semibold tracking-wider uppercase text-on-surface-variant">Breakdown of spending by utility type</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="relative z-10 p-4 sm:p-6" id="utility-content">
            {monthLoading ? (
              <div className="flex items-center justify-center py-12">
                <Loader2 className="h-6 w-6 animate-spin text-[#212529]" />
                <span className="ml-2 text-sm text-[#5b5f63]">Loading utility analytics...</span>
              </div>
            ) : (
        ...
        <CardContent className="relative z-10 space-y-6">
          {monthLoading ? (
            ...
            <div className="text-center py-12">
              <span className="material-symbols-outlined text-5xl text-[#c4c7c8] dark:text-[#353a40] mb-4">target</span>
              <p className="font-sans text-sm text-on-surface-variant mb-4">No budget set for {monthName}</p>
              <BudgetDialog
            ...
            <div className="space-y-6">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-sans text-sm font-semibold text-on-surface">{config.label}</h4>
                      ...
                      <div className="text-right">
                        <p className={`font-sans text-base font-semibold ${isOverBudget && !isSavings ? 'text-[#ba1a1a]' :
                          isSavings && spentAmount >= budgetAmount ? 'text-tertiary' :
                            'text-on-surface'
                          }`}>
                    ...
                    <div className="relative">
                      <Progress
                        ...
                        className={`h-3 ${isOverBudget && !isSavings ? 'bg-red-100 dark:bg-red-900/20' :
              ...
              <div className="border-t border-outline-variant pt-6">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-sans text-base font-semibold text-on-surface">Total Budget Summary</h4>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setShowAmounts(!showAmounts)}
                    className="h-8 w-8 p-0 text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors rounded-lg"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <motion.div
                    className="text-center p-4 rounded-xl bg-surface-container-low border border-outline-variant/50"
                    whileHover={{ scale: 1.02 }}
                  >
                    <p className="font-sans text-sm text-on-surface-variant">Total Budget</p>
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <p className="font-sans text-sm text-on-surface-variant">Total Spent</p>
                    <p className="font-sans text-lg font-semibold text-on-surface">
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <p className="font-sans text-sm text-on-surface-variant">Remaining</p>
                    <p className={`font-sans text-lg font-semibold ${totalExpenses > ((budget.needBudget || 0) + (budget.wantBudget || 0) + (budget.selfDevelopmentBudget || 0)) ?
                      'text-[#ba1a1a]' : 'text-tertiary'
                      }`}>
                      {formatAmount(
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm font-sans font-medium text-on-surface-variant mt-1">
                    Spending & Savings Breakdown for {monthName}
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
              ...
              <div className="flex items-center gap-2 justify-center sm:justify-end">
                <Button
                  ...
                  className="h-8 w-8 p-0 text-on-surface-variant hover:text-on-surface hover:bg-surface-container rounded-lg transition-colors"
                >
                ...
                <Button
                  variant="ghost"
                  className="flex items-center gap-1 sm:gap-2 min-w-[100px] sm:min-w-[160px] justify-center hover:bg-surface-container text-on-surface text-sm font-sans font-semibold px-3 py-2 rounded-lg border border-outline-variant transition-colors shadow-sm"
                  onClick={() => setShowMonthPicker(true)}
                >
                  <span className="material-symbols-outlined text-sm flex-shrink-0">calendar_month</span>
                ...
                {isMobile ? (
                  <Dialog open={showMonthPicker} onOpenChange={setShowMonthPicker}>
                    <DialogContent className="sm:max-w-[425px]">
                      <DialogHeader>
                        <DialogTitle className="text-lg sm:text-xl font-serif-heading">Select Month & Year</DialogTitle>
                      </DialogHeader>
                ...
                {!isCurrentMonth && (
                  <Button
                    ...
                    className="ml-1 sm:ml-2 font-sans font-semibold text-sm px-3 rounded-lg border-outline-variant text-on-surface hover:bg-surface-container shadow-sm transition-colors"
                  >
                    Today
                  </Button>
                )}
                ...
                >
                  <Button
                    ...
                    className="flex items-center gap-2 ml-1 sm:ml-2 text-sm px-4 py-2 rounded-lg bg-[#f0f4f8] hover:bg-[#eaeef2] text-[#171c1f] dark:bg-[#1c2024] dark:hover:bg-[#24282c] dark:text-[#f6fafe] border border-outline-variant transition-colors font-sans font-semibold shadow-sm disabled:opacity-50"
            ...
            {monthLoading && !optimisticUpdateActive ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4">
                  <Loader2 className="h-8 w-8 animate-spin mx-auto text-[#5e604d]" />
                  <p className="text-sm text-[#8b8579] dark:text-[#a39e93]">Loading {monthName} data...</p>
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  {Object.entries(categoryConfig).filter(([key]) => key !== 'SAVINGS').map(([key, config], index) => (
                    <motion.div
                      key={key}
                      className="text-center p-4 rounded-xl bg-[#ffffff] dark:bg-[#14171a] border border-outline-variant/50"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                ...
                <div className="border-t border-outline-variant pt-4 mt-6">
                  <h4 className="font-sans text-sm font-semibold text-on-surface mb-3 flex items-center gap-2">
                    <span className="material-symbols-outlined text-[18px] text-tertiary">savings</span>
                    Savings Summary
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <motion.div
                      className="text-center p-4 rounded-xl bg-surface-container-low border border-outline-variant/50 relative group transition-all shadow-sm"
                    ...
                    >
                      <div className="flex items-center justify-center relative mb-1">
                        ...
                        <Button
                          ...
                          className="absolute right-0 h-7 w-7 text-tertiary hover:bg-surface-container rounded-lg transition-colors"
      ...
      <Dialog open={isEditingMonthlySavings} onOpenChange={setIsEditingMonthlySavings}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-on-surface font-serif-heading text-xl">
