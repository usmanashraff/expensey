...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-4 sm:gap-6 rounded-none sm:rounded-xl border-y sm:border-x sm:border border-border/50 sm:border-border py-4 sm:py-6 shadow-sm sm:shadow-md",
        className
      )}
      {...props}
    />
